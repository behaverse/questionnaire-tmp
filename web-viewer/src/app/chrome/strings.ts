const STRINGS = {
  en: {
    ...
    error_invite_invalid_title: 'Invalid or expired link',
    error_invite_invalid_body: 'This invite link is invalid or has expired. Ask the person who sent it for a new link.',
    retry: 'Try again',
  ...
  pt: {
    ...
    error_invite_invalid_title: 'Ligação inválida ou expirada',
    error_invite_invalid_body: 'Este link de convite é inválido ou expirou. Peça um novo link a quem o enviou.',
    retry: 'Tentar novamente',
    results_title: 'Os seus resultados',
