const STRINGS = {
  en: {
    ...
    comment_help: 'For quality review, not part of your answers.',
    comment_placeholder: 'Your comment',
    comment_stars_label: 'Rate this question',
    comment_submit: 'Send',
    comment_cancel: 'Cancel',
    comment_thanks: 'Thanks!',
  },
  pt: {
    ...
    comment_help: 'Para revisão de qualidade, não faz parte das suas respostas.',
    comment_placeholder: 'O seu comentário',
    comment_stars_label: 'Classifique esta pergunta',
    comment_submit: 'Enviar',
    comment_cancel: 'Cancelar',
    comment_thanks: 'Obrigado!',
  },
} as const
