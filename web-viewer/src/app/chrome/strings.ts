const STRINGS = {
  en: {
    ...
    comment_button: 'Comment on this question',
    comment_title: 'Comment on this question',
    comment_help: 'Spotted something unclear or off? Tell us — this is for quality review, not part of your answers.',
    comment_placeholder: 'Your comment (optional if you give a rating)',
    comment_stars_label: 'Rate this question (optional)',
    comment_submit: 'Send comment',
    comment_cancel: 'Cancel',
    comment_thanks: 'Thanks for your comment!',
  },
  pt: {
    ...
    comment_button: 'Comentar esta pergunta',
    comment_title: 'Comentar esta pergunta',
    comment_help: 'Notou algo pouco claro ou inadequado? Diga-nos — isto serve para revisão de qualidade, não faz parte das suas respostas.',
    comment_placeholder: 'O seu comentário (opcional se atribuir uma classificação)',
    comment_stars_label: 'Classifique esta pergunta (opcional)',
