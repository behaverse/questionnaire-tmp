...
test('parseParams reads deployment/locale/viewer_url/fixture/theme', () => {
  expect(parseParams('?deployment=dpl_1&locale=pt&viewer_url=http://vs:9&fixture=mini&theme=sage')).toEqual({
    ...
    identityBaseUrl: 'http://localhost:8100', invite: null, returnUrl: null, preview: null, handoff: null, mouseHz: null, replay: null, follow: false,
  })
  expect(parseParams('')).toEqual({ deploymentId: null, locale: null, vsBaseUrl: 'http://localhost:8001', fixture: null, theme: null, identityBaseUrl: 'http://localhost:8100', invite: null, returnUrl: null, preview: null, handoff: null, mouseHz: null, replay: null, follow: false })
})
