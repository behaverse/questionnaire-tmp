...
export type Params = { deploymentId: string | null; locale: string | null; vsBaseUrl: string; fixture: string | null; theme: string | null; identityBaseUrl: string; invite: string | null; returnUrl: string | null; preview: string | null; handoff: string | null; mouseHz: number | null; replay: string | null; follow: boolean }
