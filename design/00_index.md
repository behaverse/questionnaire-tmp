...
**Last revised.** 2026-06-03 (OD-18 resolved + implemented as Schemas 3+7 v26.0603; **OD-19 opened** — Schema 4a (xAPI Event Data) JSON Schema shape: strict-profile-vs-subset choice, verb IRI sources, Schema 5 wrapping mechanism, statement vs batch validation, extension value-type contracts; body in [10_open_decisions.md](10_open_decisions.md) §"OD-19"). 17 prior ODs resolved (OD-18 resolved 2026-06-03; OD-17 resolved 2026-06-03; OD-16 resolved 2026-06-02; OD-15 resolved 2026-05-31; OD-01, OD-12, OD-13 resolved 2026-05-23; OD-05/06/07/09/10/11/14 resolved 2026-05-21; OD-03/04/08 resolved 2026-05-15). Versioning aligned with the [Behaverse schemas policy](https://behaverse.org/schemas/#versioning) — Calendar Versioning (`vYY.MMDD`) replaces SemVer across schemas, questionnaires, and reusable entities.
...
| 05e | [05e_events_vocabulary.md](05e_events_vocabulary.md) | OD-19 (in progress) — BDM Events vocabulary: 16 verbs across 4 layers (session lifecycle, presentation, response activity, navigation/capture); polymorphic vs specific verb best practices; object types + extension keys; covers both questionnaires and cognitive tasks; designed for BDM upstream extension | Draft |
