...
**Last revised.** 2026-06-05 (**OD-20 opened** — Schema 4b (Behavioural Channels) shape: per-source content schemas vs single polymorphic, which sources to ship in MVP, per-sample schemas for mouse and keyboard, manifest placement, file naming. Body in [10_open_decisions.md](10_open_decisions.md) §"OD-20". **OD-19 resolved** — BDM Events vocabulary for Schema 4a: own `bdm:` namespace, 24 verbs across 6 layers, 15 object types, 5 actor types, ~50 extension keys covering questionnaires + cognitive tasks + video games. Three BDM upstream-change deviations logged in [05c_bdm_alignment.md](05c_bdm_alignment.md) for handoff. Body in [05e_events_vocabulary.md](05e_events_vocabulary.md), Resolution-log row in [10_open_decisions.md](10_open_decisions.md)). All 18 originally-tracked open decisions now resolved (OD-19 resolved 2026-06-05; OD-18 resolved 2026-06-03; OD-17 resolved 2026-06-03; OD-16 resolved 2026-06-02; OD-15 resolved 2026-05-31; OD-01, OD-12, OD-13 resolved 2026-05-23; OD-05/06/07/09/10/11/14 resolved 2026-05-21; OD-03/04/08 resolved 2026-05-15). Versioning aligned with the [Behaverse schemas policy](https://behaverse.org/schemas/#versioning) — Calendar Versioning (`vYY.MMDD`) replaces SemVer across schemas, questionnaires, and reusable entities.
