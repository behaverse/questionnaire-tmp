...
**Last revised.** 2026-06-03 (OD-17 resolved + implemented as Schemas 5+6 v26.0603; **OD-18 opened** — Schema 3 (Questionnaire Runtime) shape and production model: server vs client production, locale handling, conformance manifest, Scorer impl selection, scoring stripping under show_score, cache key; body in [10_open_decisions.md](10_open_decisions.md) §"OD-18"). 16 prior ODs resolved (OD-17 resolved 2026-06-03; OD-16 resolved 2026-06-02; OD-15 resolved 2026-05-31; OD-01, OD-12, OD-13 resolved 2026-05-23; OD-05/06/07/09/10/11/14 resolved 2026-05-21; OD-03/04/08 resolved 2026-05-15). Versioning aligned with the [Behaverse schemas policy](https://behaverse.org/schemas/#versioning) — Calendar Versioning (`vYY.MMDD`) replaces SemVer across schemas, questionnaires, and reusable entities.
