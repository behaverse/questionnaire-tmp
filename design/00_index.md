...
**Last revised.** 2026-06-03 (**OD-18 resolved** — Schema 3 (Questionnaire Runtime) shape and production model; server-side Viewer Service generation; single-locale default; new formal **Schema 7 — Viewer Conformance Manifest** sibling; shared denormaliser Python library; Postgres-backed cache; six sub-decisions resolved. Body in [05d_runtime.md](05d_runtime.md), Resolution-log row in [10_open_decisions.md](10_open_decisions.md)). All 17 originally-tracked open decisions now resolved (OD-18 resolved 2026-06-03; OD-17 resolved 2026-06-03; OD-16 resolved 2026-06-02; OD-15 resolved 2026-05-31; OD-01, OD-12, OD-13 resolved 2026-05-23; OD-05/06/07/09/10/11/14 resolved 2026-05-21; OD-03/04/08 resolved 2026-05-15). Versioning aligned with the [Behaverse schemas policy](https://behaverse.org/schemas/#versioning) — Calendar Versioning (`vYY.MMDD`) replaces SemVer across schemas, questionnaires, and reusable entities.
