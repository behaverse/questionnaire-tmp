# Schema 4b — Mouse Recording Sample

Per OD-20 (resolved 2026-06-05), Schema 4b family member for mouse-channel recordings. Each sample is `{t, x, y, button_state}`. See [design/05_data_model.md](../../../design/05_data_model.md) §"Schema 4b" and [design/05e_events_vocabulary.md](../../../design/05e_events_vocabulary.md) §2.5 (recording lifecycle).
...
- `x`, `y` — viewport pixels (integer)
- `button_state` — enum: `up` / `left_down` / `right_down` / `middle_down`
...
- [schemas/recordings/keyboard/](../keyboard/) — Sibling: keyboard recordings
